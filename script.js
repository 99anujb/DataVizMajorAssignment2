    ...
    const createMap = (container, colorScale, property, isGini = false) => {
        ...
        svg.selectAll("path")
            ...
            .attr("fill", d => {
                ...
                return '#ccc'; // Fallback color for missing data
            })
            .on("mouseenter", (event, d) => {
                const value = isGini ? fipsMap[d.properties.FIPS_STCO] : (typeof property === 'function' ? property(d) : d.properties[property]);
                tooltip.style("opacity", 1)
                    .html(`${d.properties.TOWN || d.properties.county}: ${value !== undefined && value !== null ? value : 'N/A'}`)
